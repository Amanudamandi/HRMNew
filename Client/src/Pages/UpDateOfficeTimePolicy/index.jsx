...
const UpdateEmpPolicyDetailTable =()=> {
    ...
    useEffect(() => {
        ...
        if (selectedPolicyId) {
            ...
            axios.get(`${process.env.REACT_APP_SERVER_ADDRESS}/common/show-officeTimePolicy?policyId=${selectedPolicyId}`)
                .then((response) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const dataToSend = { 
                policyId: Cookies.get('selectedPolicyId'), 
                ...formData,
                allowedLateDaysInMonth: formData.allowedLateDaysInMonth ? Number(formData.allowedLateDaysInMonth) : 0,
                salaryCutPercentage: formData.salaryCutPercentage ? Number(formData.salaryCutPercentage) : 0
            };
