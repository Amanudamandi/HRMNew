...
const ShiftDetailsTable = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setDuration(''); // Reset duration as well
    } catch (error) {
    ...
    <div className='flex flex-col justify-between gap-8 mt-4'>
      <form onSubmit={handleSubmit}>
        ...
        <div className='ml-2 mr-2'>
          ...
          {/* shift name field  */}
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  xl:grid-cols-4 gap-4 mt-4 pb-6'>
            <div className='flex flex-col'>
              ...
              <input 
                type='text'
                className="ml-8 mr-20 rounded-md border-2 border-gray-500 py-2 px-2 focus:outline-none focus:ring-2 focus:ring-black"
                name="name"
            ...
            <div className='flex flex-col'>
              <label className='pb-2'>
                ...
                <p className='ml-8 mr-20 rounded-md border-2 border-gray-500 py-2 px-2 focus:outline-none focus:ring-2 focus:ring-black'>{duration}</p>
            </div>
          </div>
        </div>
