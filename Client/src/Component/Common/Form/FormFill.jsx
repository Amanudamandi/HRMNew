...
const FormFill = ({ formData, api,setFormData }) => {
   const navigate=useNavigate();
    ...
    const validateForm = () => {
        ...
        if (!formData.panCard) {
            ...
            console.log("Current value of pancard ", formData.panCard);
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`${process.env.REACT_APP_SERVER_ADDRESS}${api}`, formData, {
                   ...
                   {/* permanent pin code field  */}
                    ...
                    <div>
                      ...
                      <input type='text' 
                        ...
                        name='panCard'
                        onChange={handleFormData}
                        className="w-full rounded-md border-2 py-1 px-4  border-gray-400 uppercase "
                      />
                    ...
                    <div>
                      ...
                      <input type='text' 
                        ...
                        name='aadharCard'
                        onChange={handleFormData}
                        className="w-full rounded-md border-2 py-1 px-4  border-gray-400 " required
                      />
                ...
                <fieldset className='border-2  rounded-md' style={{ borderColor: '#740FD6'}}>
                  ...
                  <div className='grid gap-3 m-6 md:grid-cols-4'>
                    ...
                    <div>
                      ...
                      <input type='file' 
                        onChange={(e) => handleFileChange(e, 'photoAttachment')} required
